...
    useEffect(() => {
        fetch(`https://8080-dfacffdfabfdabddffdbddfadbecbaeee.project.examly.io/user/getAdmission/${id}`)
...
         }
       
         fetch(`https://8080-dfacffdfabfdabddffdbddfadbecbaeee.project.examly.io/user/editAdmission/${id}`, {
           method: 'PUT',
           headers: {
