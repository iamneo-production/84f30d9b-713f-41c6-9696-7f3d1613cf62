...
    useEffect(() => {
        fetch(`https://8080-eeaabaccbcfabfdabddffdbddfadbecbaeee.project.examly.io/user/getAdmission/${id}`)
...
         }
       
         fetch(`https://8080-eeaabaccbcfabfdabddffdbddfadbecbaeee.project.examly.io/user/editAdmission/${id}`, {
           method: 'PUT',
           headers: {
