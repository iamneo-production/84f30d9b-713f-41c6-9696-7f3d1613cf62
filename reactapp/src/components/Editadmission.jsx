...
    useEffect(() => {
        fetch(`https://8080-dfffaaaaabccbabfdabddffdbddfadbecbaeee.project.examly.io/user/getAdmission/${id}`)
...
         }
       
         fetch(`https://8080-dfffaaaaabccbabfdabddffdbddfadbecbaeee.project.examly.io/user/editAdmission/${id}`, {
           method: 'PUT',
           headers: {
