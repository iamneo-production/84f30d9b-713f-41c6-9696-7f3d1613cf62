...
    useEffect(() => {
        fetch(`https://8080-dabcfdceacfcabfdabddffdbddfadbecbaeee.project.examly.io/user/getAdmission/${id}`)
...
         }
       
         fetch(`https://8080-dabcfdceacfcabfdabddffdbddfadbecbaeee.project.examly.io/user/editAdmission/${id}`, {
           method: 'PUT',
           headers: {
