...
function Editcourse() {
  ...
  useEffect(() => {
    ...
    fetch(`https://8080-dabcfdceacfcabfdabddffdbddfadbecbaeee.project.examly.io/admin/GetCourse/${id}`)
  ...
  const handleUpdate = () => {
    ...
    fetch(`https://8080-dabcfdceacfcabfdabddffdbddfadbecbaeee.project.examly.io/admin/editCourse/${id}`, {
