...
function Editcourse() {
  ...
  useEffect(() => {
    ...
    fetch(`https://8080-baedadabfababfdabddffdbddfadbecbaeee.project.examly.io/admin/GetCourse/${id}`)
  ...
  const handleUpdate = () => {
    ...
    fetch(`https://8080-baedadabfababfdabddffdbddfadbecbaeee.project.examly.io/admin/editCourse/${id}`, {
