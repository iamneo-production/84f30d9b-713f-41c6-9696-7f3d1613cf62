...
function Editcourse() {
  ...
  useEffect(() => {
    ...
    fetch(`https://8080-eeaabaccbcfabfdabddffdbddfadbecbaeee.project.examly.io/admin/GetCourse/${id}`)
  ...
  const handleUpdate = () => {
    ...
    fetch(`https://8080-eeaabaccbcfabfdabddffdbddfadbecbaeee.project.examly.io/admin/editCourse/${id}`, {
