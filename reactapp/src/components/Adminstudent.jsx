...
function Adminstudent() {
  ...
  useEffect(() => {
    fetch('https://8080-dabcfdceacfcabfdabddffdbddfadbecbaeee.project.examly.io/admin/ViewStudent')
  ...
  const handleDelete = (studentId) => {
    fetch(`https://8080-dabcfdceacfcabfdabddffdbddfadbecbaeee.project.examly.io/admin/deleteStudent/${studentId}`, {
      method: 'DELETE',
    })
      .then((response) => response.json())
      .then((data) => {
