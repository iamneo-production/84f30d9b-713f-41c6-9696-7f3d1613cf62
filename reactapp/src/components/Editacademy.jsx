...
function Editacademy() {
  ...
  const handleLogout = () =>
    ...
    fetch(`https://8080-dfffaaaaabccbabfdabddffdbddfadbecbaeee.project.examly.io/admin/GetInstitute/${id}`)
  ...
  const handleUpdate = () => {
    ...
    fetch(`https://8080-dfffaaaaabccbabfdabddffdbddfadbecbaeee.project.examly.io/admin/editInstitute/${id}`, {
