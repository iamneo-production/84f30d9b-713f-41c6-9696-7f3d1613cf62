...
function Editacademy() {
  ...
  const handleLogout = () =>
    ...
    fetch(`https://8080-dfacffdfabfdabddffdbddfadbecbaeee.project.examly.io/admin/GetInstitute/${id}`)
  ...
  const handleUpdate = () => {
    ...
    fetch(`https://8080-dfacffdfabfdabddffdbddfadbecbaeee.project.examly.io/admin/editInstitute/${id}`, {
