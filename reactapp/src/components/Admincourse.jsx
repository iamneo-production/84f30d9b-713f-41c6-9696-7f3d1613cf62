...
function Admincourse() {
  ...
  useEffect(() => {
    ...
    fetch('https://8080-dabcfdceacfcabfdabddffdbddfadbecbaeee.project.examly.io/admin/viewCourse')
  ...
  const handleDelete = (courseId) => {
    ...
    fetch(`https://8080-dabcfdceacfcabfdabddffdbddfadbecbaeee.project.examly.io/admin/deleteCourse/${courseId}`, {
