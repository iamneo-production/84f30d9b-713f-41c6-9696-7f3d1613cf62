...
function Adminacademy() {
  ...
  useEffect(() => {
    fetch('https://8080-dfffaaaaabccbabfdabddffdbddfadbecbaeee.project.examly.io/admin/viewInstitutes')
  ...
  const handleDelete = (instituteId) => {
    fetch(`https://8080-dfffaaaaabccbabfdabddffdbddfadbecbaeee.project.examly.io/admin/deleteInstitute/${instituteId}`, {
      method: 'DELETE',
    })
      .then((response) => response.json())
      .then((data) => {
